...
# 加载并预处理数据
def load_and_preprocess_data(dataset_path, tokenizer, batch_size, max_length=2048):
    # 加载数据
...
if __name__ == "__main__":
    ...
    # 加载模型与分词器
    model, tokenizer, _ = load_model_and_tokenizer(model_path, 8)

    # 加载并预处理数据
    train_dataloader, eval_dataloader, dataset = load_and_preprocess_data(dataset_path, tokenizer, batch_size)
